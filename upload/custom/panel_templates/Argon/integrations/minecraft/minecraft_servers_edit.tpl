    ...
    <div class="header bg-gradient-primary pb-9 pt-5 pt-md-7">
        <div class="container-fluid">
            <div class="header-body">
                <h1 class="text-white">{$EDITING_SERVER}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <h6 class="h3">{$SERVER_INFORMATION}</h6>
                        ...
                        <div class="form-group">
                            <label for="InputAddress">{$SERVER_ADDRESS}</label> <span class="badge badge-info"><i
                                        ...
                                        data-placement="top" title="{$INFO}" data-content="{$SERVER_ADDRESS_INFO}"></i></span>
                        ...
                        <h6 class="h3">{$QUERY_INFORMATION}</h6>
                        <div class="form-group">
                        ...
                        {/if}
                        <div class="form-group">
                            <label for="inputQueryEnabled">{$ENABLE_PLAYER_LIST}</label> <span class="badge badge-info"><i
                                        class="fa fa-question-circle" data-container="body" data-toggle="popover"
