...
<div class="main-content">
    ...
    <div class="container-fluid mt--8">
        ...
        <div class="alert alert-danger">
            ...
            <div class="card">
                <div class="card-body">
                    <button onclick="showSearchModal()" class="btn btn-info"><i class="fa fa-search"></i> {$SEARCH}
                    </button>
                                ...
                                {foreach from=$RESULTS item=result}
                                    <tr>
                                        <td><a href="{$result.profile}" style="{$result.style}"><img
                                                        ...
                                                        style="max-width:25px;max-height:25px;"> {$result.nickname}</a>
                                        </td>
                                        ...
                                        <td><span data-toggle="tooltip"
                                                  data-original-title="{$result.time_full}">{$result.time}</span></td>
