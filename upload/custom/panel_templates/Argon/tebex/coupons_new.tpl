    ...
    <div class="header bg-gradient-primary pb-9 pt-5 pt-md-7">
        <div class="container-fluid">
            <div class="header-body">
                <h1 class="text-white">{$CREATING_COUPON}</h1>
            </div>
        </div>
    </div>
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input id="inputCode" type="text" class="form-control" name="code"
                                   placeholder="{$COUPON_CODE}" value="{$COUPON_CODE_VALUE}">
                        </div>
                        ...
                        <div class="form-group" id="effectiveOnPackages">
                            <label for="inputEffectiveOnPackages">{$PACKAGES}</label>
                            <small>{$SELECT_MULTIPLE_WITH_CTRL}</small>
                        ...
                        <div class="form-group" id="effectiveOnCategories">
                            <label for="inputEffectiveOnCategories">{$CATEGORIES}</label>
                            <small>{$SELECT_MULTIPLE_WITH_CTRL}</small>
                                ...
                                <div class="form-group" id="discountTypeValue">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="discount_amount"
                                               id="inputDiscountTypeValue" placeholder="{$DISCOUNT_TYPE_VALUE}"
                                               value="{$DISCOUNT_TYPE_VALUE_VALUE}" step="0.01">
                                    </div>
                                </div>
                                <div class="form-group" id="discountTypePercentage">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" name="discount_percentage"
                                               id="inputDiscountTypePercentage"
                                               placeholder="{$DISCOUNT_TYPE_PERCENTAGE}"
                                               value="{$DISCOUNT_TYPE_PERCENTAGE_VALUE}">
                        ...
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="redeem_unlimited" id="inputRedeemUnlimited"
                                           class="js-switch" {if $UNLIMITED_USAGE_VALUE}checked {/if}/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="redeemLimit">
                                    <label for="inputRedeemLimit">{$USES}</label>
                                    <input type="number" class="form-control" name="expire_limit" id="inputRedeemLimit"
                                           placeholder="{$USES}" value="{$USES_VALUE}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 align-self-center">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="expire_never" id="inputExpireNever" class="js-switch"
                                           {if $NEVER_EXPIRE_VALUE}checked {/if}/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="expireDate">
                                    <label for="inputExpiryDate">{$EXPIRY_DATE}</label>
                                    <input type="text" class="form-control" name="expire_date" id="inputExpiryDate"
                                           placeholder="{$EXPIRY_DATE}" value="{$EXPIRY_DATE_VALUE}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="start_date" id="inputStartDate"
                                   placeholder="{$START_DATE}" value="{$START_DATE_VALUE}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="discount_application_method"
                                    id="inputDiscountApplicationType">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" name="minimum" id="inputMinimum"
                                       placeholder="{$MINIMUM_SPEND}" value="{$MINIMUM_SPEND_VALUE}" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputUsername" name="username"
                                   placeholder="{$USER_COUPON_FOR}" value="{$USER_COUPON_FOR_VALUE}">
                        </div>
